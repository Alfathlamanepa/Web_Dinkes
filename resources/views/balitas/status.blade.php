...
<body class="p-8 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-8 rounded-xl shadow-2xl max-w-2xl w-full filter-container">
        ...
        <form action="{{ route('balitas.status') }}" method="GET" class="mb-8 p-6 rounded-3xl shadow-inner" style="background-color: #F8F9FA;">
        ...
        <div class="space-y-4">
            <a href="{{ route('balitas.status.show', ['status' => 'aman', 'kec' => request('kec'), 'puskesmas' => request('puskesmas'), 'desa_kel' => request('desa_kel')]) }}" class="block">
                <div class="p-5 rounded-lg border-2 flex items-center justify-between transition-all duration-300 transform hover:scale-105 cursor-pointer border-green-500">
                    ...
                    <div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold text-white shadow-md bg-green-500">{{ count($aman) }}</div>
                </div>
            </a>
            ...
            <a href="{{ route('balitas.status.show', ['status' => 'mendekati', 'kec' => request('kec'), 'puskesmas' => request('puskesmas'), 'desa_kel' => request('desa_kel')]) }}" class="block">
                <div class="p-5 rounded-lg border-2 flex items-center justify-between transition-all duration-300 transform hover:scale-105 cursor-pointer border-yellow-400">
                    ...
                    <div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold text-white shadow-md bg-yellow-400">{{ count($mendekati) }}</div>
                </div>
            </a>
            ...
            <a href="{{ route('balitas.status.show', ['status' => 'lewat', 'kec' => request('kec'), 'puskesmas' => request('puskesmas'), 'desa_kel' => request('desa_kel')]) }}" class="block">
                <div class="p-5 rounded-lg border-2 flex items-center justify-between transition-all duration-300 transform hover:scale-105 cursor-pointer border-red-500">
                    ...
                    <div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold text-white shadow-md bg-red-500">{{ count($lewat) }}</div>
                </div>
            </a>
            
            @if(count($aman) === 0 && count($mendekati) === 0 && count($lewat) === 0)
