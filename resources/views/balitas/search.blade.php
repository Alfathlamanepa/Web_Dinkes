...
<body class="p-8 flex items-center justify-center min-h-screen">
            ...
            @if($balita)
                <div class="p-6 rounded-xl border-2 border-green-400 shadow-lg">
                    ...
                    <div class="mt-6 flex justify-end space-x-2">
                        {{-- HANYA Tombol Lihat Detail yang dipertahankan --}}
                        ...
                        {{-- Tombol Edit Data Balita telah dihapus --}}
                    </div>
                </div>
            @else
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Tampilkan modal jika NIK tidak ditemukan
            ...
            // Sembunyikan modal jika pengguna mengklik di luar modal
