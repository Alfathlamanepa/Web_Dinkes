...
<head>
    ...
    <style>
        ...
        @media (max-width: 640px) {
            ...
            .grid-cols-1.md\:grid-cols-2 > div.md\:col-span-2 {
...
<body class="p-8 flex items-center justify-center min-h-screen">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Logika untuk pop-up konfirmasi
            ...
            if (oldKec) {
                ...
                if (dataLokasi[oldKec]) {
                    const puskesmasOptions = Object.keys(dataLokasi[oldKec]);
                    populateDropdown(puskesmasSelect, puskesmasOptions, 'Pilih Puskesmas');
                    if (oldPuskesmas) {
                        puskesmasSelect.value = oldPuskesmas;
                        if (dataLokasi[oldKec][oldPuskesmas]) {
                            const desaOptions = Object.keys(dataLokasi[oldKec][oldPuskesmas]);
                            populateDropdown(desaKelSelect, desaOptions, 'Pilih Desa/Kelurahan');
                            if (oldDesaKel) {
                                desaKelSelect.value = oldDesaKel;
                                if (dataLokasi[oldKec][oldPuskesmas][oldDesaKel]) {
                                    const posyanduOptions = dataLokasi[oldKec][oldPuskesmas][oldDesaKel];
                                    populateDropdown(posyanduSelect, posyanduOptions, 'Pilih Posyandu');
                                    
                                    if (oldPosyandu) {
                                        posyanduSelect.value = oldPosyandu;
                                    }
                                }
                            }
                        }
            ...
            generateButton.addEventListener('click', function() {
                ...
                if (!tanggalLahir || !jenisKelamin || !kecamatan) {
                    const msg = 'Mohon isi Tanggal Lahir, Jenis Kelamin, dan Kecamatan terlebih dahulu.';
                    alert(msg);
