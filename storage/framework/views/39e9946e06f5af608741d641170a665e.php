...
<body class="p-8 flex items-center justify-center min-h-screen">
    <div class="bg-white p-6 rounded-2xl shadow-2xl max-w-xl w-full">
        ...
        <form action="<?php echo e(route('balitas.search')); ?>" method="GET" class="mb-6">
            <div class="flex items-center space-x-2">
                <input type="text" id="nik_input" name="nik_balita" placeholder="Masukkan NIK Balita" class="flex-grow rounded-xl border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="<?php echo e(request('nik_balita')); ?>">
            ...
            <?php if($balita): ?>
                <div class="p-6 rounded-xl border-2 border-green-400 shadow-lg">
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-800"><?php echo e($balita->nama_balita); ?></h3>
                            <p class="text-sm text-gray-500">NIK: <?php echo e($balita->nik_balita); ?></p>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <strong>Nama Ortu:</strong> <span class="font-normal"><?php echo e($balita->nama_ortu); ?></span>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <strong>Tanggal Lahir:</strong> <span class="font-normal"><?php echo e($balita->tgl_lahir); ?></span>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg col-span-1 md:col-span-2">
                            <strong>Alamat:</strong> <span class="font-normal"><?php echo e($balita->provinsi); ?>, <?php echo e($balita->kab_kota); ?>, <?php echo e($balita->kec); ?>, <?php echo e($balita->desa_kel); ?></span>
                        </div>
                    </div>
                    <div class="mt-6 flex justify-end space-x-2">
                        <a href="<?php echo e(route('balitas.show', ['balita' => $balita->nik_balita, 'from' => 'search'])); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-xl shadow-sm text-white btn-action" style="background-color: #008080; hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors duration-200">
                            Lihat Detail
                        </a>
                        <a href="<?php echo e(route('balitas.edit', ['balita' => $balita->nik_balita, 'from' => 'search'])); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-xl shadow-sm text-white btn-action" style="background-color: #99E600; hover:bg-lime-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime-500 transition-colors duration-200">
                            Edit Data Balita
                        </a>
                    </div>
                </div>
                ...
                <div id="notFoundModal" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="p-4 text-center">
                            ...
                            <a href="<?php echo e(route('balitas.create')); ?>" class="inline-block bg-green-700 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-800 transition duration-200">
        ...
        <div class="mt-6 text-center">
            <a href="<?php echo e(url('/')); ?>" class="text-green-800 hover:text-indigo-900 font-medium transition-colors duration-200">Kembali ke Menu Utama</a>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if(request('nik_balita') && !$balita): ?>
...
</html><?php /**PATH C:\xampp\htdocs\balita-app\resources\views/balitas/search.blade.php ENDPATH**/ ?>