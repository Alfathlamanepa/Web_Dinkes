...
<body class="p-8">
    <div class="max-w-7xl mx-auto space-y-8">
        <div class="header-container">
            ...
            <a href="<?php echo e(url('/')); ?>" class="home-button" title="Kembali ke Beranda">
        ...
        <div class="bg-white p-8 rounded-xl shadow-2xl">
            ...
            <form id="filter-form" action="<?php echo e(route('balitas.index')); ?>" method="GET" class="hidden mb-6 p-4 rounded-xl" style="background-color: #f0f2f5;">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                        <label for="kec_custom" class="block text-sm font-semibold text-gray-700">Kecamatan</label>
                        <div class="custom-dropdown-container">
                            <input type="hidden" id="kec" name="kec" value="<?php echo e(request('kec')); ?>">
                    ...
                    <div>
                        ...
                        <div class="custom-dropdown-container">
                            <input type="hidden" id="puskesmas" name="puskesmas" value="<?php echo e(request('puskesmas')); ?>">
                    ...
                    <div>
                        ...
                        <div class="custom-dropdown-container">
                            <input type="hidden" id="desa_kel" name="desa_kel" value="<?php echo e(request('desa_kel')); ?>">
                    ...
                    <div class="p-4 text-center">
                        ...
                        <div class="flex justify-center space-x-4">
                            <form id="delete-form-modal" method="POST" action="">
                                ...
                                <input type="hidden" name="page" value="<?php echo e($balitas->currentPage()); ?>">
            ...
            <?php else: ?>
                <div class="overflow-x-auto hidden sm:block">
                    <table class="min-w-full rounded-xl overflow-hidden">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-50" id="balita-<?php echo e($balita->nik_balita); ?>">
                                <td class="py-3 px-6 text-left whitespace-nowrap"><?php echo e($balita->nama_balita); ?></td>
                                <td class="py-3 px-6 text-left"><?php echo e($balita->nik_balita); ?></td>
                                <td class="py-3 px-6 text-left" data-tgl-lahir="<?php echo e($balita->tgl_lahir); ?>"><?php echo e($balita->tgl_lahir); ?></td>
                                <td class="py-3 px-6 text-center age-display" data-tgl-lahir="<?php echo e($balita->tgl_lahir); ?>"></td>
                                <td class="py-3 px-6 text-center age-status-display" data-tgl-lahir="<?php echo e($balita->tgl_lahir); ?>"></td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center space-x-2">
                                        
                                        <a href="<?php echo e(route('balitas.show', ['balita' => $balita->nik_balita, 'page' => $balitas->currentPage()])); ?>" class="text-gray-500 transform hover:text-purple-500 hover:scale-110">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        
                                        <a href="<?php echo e(route('balitas.edit', ['balita' => $balita->nik_balita, 'page' => $balitas->currentPage()])); ?>" class="text-gray-500 transform hover:text-blue-500 hover:scale-110">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        
                                        <button type="button" class="text-gray-500 transform hover:text-red-500 hover:scale-110 delete-btn" data-nik="<?php echo e($balita->nik_balita); ?>">
                ...
                <div class="card-list sm:hidden">
                    <?php $__currentLoopData = $balitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card" id="balita-card-<?php echo e($balita->nik_balita); ?>">
                        <h3 class="font-bold text-lg mb-2"><?php echo e($balita->nama_balita); ?></h3>
                        <p class="text-gray-600 mb-1">
                            <strong>NIK:</strong> <?php echo e($balita->nik_balita); ?>

                        </p>
                        <p class="text-gray-600 mb-1">
                            <strong>Tanggal Lahir:</strong> <?php echo e($balita->tgl_lahir); ?>

                        </p>
                        <p class="text-gray-600 mb-1">
                            <strong>Umur:</strong> <span class="age-display-mobile" data-tgl-lahir="<?php echo e($balita->tgl_lahir); ?>"></span>
                        </p>
                        <p class="text-gray-600 mb-4">
                            <strong>Status:</strong> <span class="age-status-display-mobile" data-tgl-lahir="<?php echo e($balita->tgl_lahir); ?>"></span>
                        </p>
                ...
                <div class="mt-8 flex justify-center">
                    <?php echo e($balitas->links('pagination::tailwind')); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            populateCustomDropdown(kecOptionsDiv, kecOptionsData, 'Semua Kecamatan', '<?php echo e(request('kec')); ?>');
            addDropdownListeners(kecButton, kecOptionsDiv, kecSelect, document.getElementById('kec_label'), 'Semua Kecamatan', dataLokasi);

            if ('<?php echo e(request('kec')); ?>') {
                const puskesmasOptionsData = Object.keys(dataLokasi['<?php echo e(request('kec')); ?>']);
                populateCustomDropdown(puskesmasOptionsDiv, puskesmasOptionsData, 'Semua Puskesmas', '<?php echo e(request('puskesmas')); ?>');
                ...
                if ('<?php echo e(request('puskesmas')); ?>') {
                    const desaKelOptionsData = Object.keys(dataLokasi['<?php echo e(request('kec')); ?>']['<?php echo e(request('puskesmas')); ?>']);
                    populateCustomDropdown(desaKelOptionsDiv, desaKelOptionsData, 'Semua Desa/Kelurahan', '<?php echo e(request('desa_kel')); ?>');
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    const url = `<?php echo e(url('balitas')); ?>/${nik}`;
...
</html><?php /**PATH C:\xampp\htdocs\balita-app\resources\views/balitas/index.blade.php ENDPATH**/ ?>