...
<body class="p-8">
    ...
    <div class="bg-white p-8 rounded-3xl shadow-2xl max-w-4xl w-full transform transition-all duration-300 hover:scale-105">
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="<?php echo e(url('/')); ?>" class="text-gray-500 hover:text-gray-700 transition-colors duration-200">
                <i class="fas fa-home text-2xl transform transition-transform duration-200 hover:scale-110"></i>
            </a>
        </div>
    
        <form id="create-form" action="<?php echo e(route('balitas.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                <div class="md:col-span-2">
                    ...
                    <div class="flex items-center space-x-2 mt-1">
                        <input type="text" id="nik_balita" name="nik_balita" class="flex-grow rounded-xl border-2 border-gray-300 shadow-inner focus:border-blue-500 focus:ring focus:ring-blue-200 px-4 py-2 transition-all duration-200" pattern="[0-9]*" inputmode="numeric" value="<?php echo e(old('nik_balita')); ?>">
                ...
                <div>
                    ...
                    <input type="text" id="nama_balita" name="nama_balita" class="mt-1 block w-full rounded-xl border-2 border-gray-300 shadow-inner focus:border-blue-500 focus:ring focus:ring-blue-200 px-4 py-2 transition-all duration-200 uppercase" oninput="this.value = this.value.toUpperCase()" value="<?php echo e(old('nama_balita')); ?>">
                </div>

                <div>
                    <label for="nama_ortu" class="block text-sm font-semibold text-gray-700">Nama Ortu</label>
                    <input type="text" id="nama_ortu" name="nama_ortu" class="mt-1 block w-full rounded-xl border-2 border-gray-300 shadow-inner focus:border-blue-500 focus:ring focus:ring-blue-200 px-4 py-2 transition-all duration-200 uppercase" oninput="this.value = this.value.toUpperCase()" value="<?php echo e(old('nama_ortu')); ?>">
                </div>
                    
                <div>
                    <label for="tgl_lahir" class="block text-sm font-semibold text-gray-700">Tanggal Lahir</label>
                    <input type="date" id="tgl_lahir" name="tgl_lahir" class="mt-1 block w-full rounded-xl border-2 border-gray-300 shadow-inner focus:border-blue-500 focus:ring focus:ring-blue-200 px-4 py-2 transition-all duration-200" value="<?php echo e(old('tgl_lahir')); ?>">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="nomor_kk" name="nomor_kk" class="mt-1 block w-full rounded-xl border-2 border-gray-300 shadow-inner focus:border-blue-500 focus:ring focus:ring-blue-200 px-4 py-2 transition-all duration-200" pattern="[0-9]*" inputmode="numeric" value="<?php echo e(old('nomor_kk')); ?>">
                </div>
        
                <div>
                    <label for="nik_ortu" class="block text-sm font-semibold text-gray-700">NIK Ortu</label>
                    <input type="text" id="nik_ortu" name="nik_ortu" class="mt-1 block w-full rounded-xl border-2 border-gray-300 shadow-inner focus:border-blue-500 focus:ring focus:ring-blue-200 px-4 py-2 transition-all duration-200" pattern="[0-9]*" inputmode="numeric" value="<?php echo e(old('nik_ortu')); ?>">
                </div>
        
                <div>
                    <label for="hp_ortu" class="block text-sm font-semibold text-gray-700">No. HP Ortu</label>
                    <input type="text" id="hp_ortu" name="hp_ortu" class="mt-1 block w-full rounded-xl border-2 border-gray-300 shadow-inner focus:border-blue-500 focus:ring focus:ring-blue-200 px-4 py-2 transition-all duration-200" pattern="[0-9]*" inputmode="numeric" value="<?php echo e(old('hp_ortu')); ?>">
                </div>
        
                <div>
                    <label for="rt" class="block text-sm font-semibold text-gray-700">RT</label>
                    <input type="text" id="rt" name="rt" class="mt-1 block w-full rounded-xl border-2 border-gray-300 shadow-inner focus:border-blue-500 focus:ring focus:ring-blue-200 px-4 py-2 transition-all duration-200" pattern="[0-9]*" inputmode="numeric" value="<?php echo e(old('rt')); ?>">
                </div>
        
                <div>
                    <label for="rw" class="block text-sm font-semibold text-gray-700">RW</label>
                    <input type="text" id="rw" name="rw" class="mt-1 block w-full rounded-xl border-2 border-gray-300 shadow-inner focus:border-blue-500 focus:ring focus:ring-blue-200 px-4 py-2 transition-all duration-200" pattern="[0-9]*" inputmode="numeric" value="<?php echo e(old('rw')); ?>">
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            (function initializeDropdownsWithOldValues() {
                const oldKec = "<?php echo e(old('kec')); ?>";
                const oldPuskesmas = "<?php echo e(old('puskesmas')); ?>";
                const oldDesaKel = "<?php echo e(old('desa_kel')); ?>";
                const oldPosyandu = "<?php echo e(old('posyandu')); ?>";
                if (oldKec) {
...
</html><?php /**PATH C:\xampp\htdocs\balita-app\resources\views/balitas/create.blade.php ENDPATH**/ ?>