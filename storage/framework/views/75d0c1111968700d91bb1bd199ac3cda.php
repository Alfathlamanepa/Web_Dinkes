...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-image: url('<?php echo e(asset('images/kesehatan.jpg')); ?>');
...
<body>
    ...
    <div class="header-logos">
        <img src="<?php echo e(asset('images/Logo Batu.png')); ?>" alt="Logo Kota Batu" class="logo-kota-batu">
        <img src="<?php echo e(asset('images/Germas.png')); ?>" alt="Logo Germas" class="logo-germas">
    </div>
    ...
    <div class="main-content">
        ...
        <div class="menu-options">
            <a href="<?php echo e(route('balitas.search')); ?>" class="menu-item">
                <div class="menu-icon">
                    <i class="fas fa-search"></i>
                </div>
                <span>Cari Balita</span>
            </a>
            <a href="<?php echo e(route('balitas.index')); ?>" class="menu-item">
                <div class="menu-icon">
                    <i class="fas fa-list-ul"></i>
                </div>
                <span>Tampilkan Data</span>
            </a>
            <a href="<?php echo e(route('balitas.create')); ?>" class="menu-item">
                <div class="menu-icon">
                    <i class="fas fa-plus-circle"></i>
                </div>
                <span>Tambah Balita</span>
            </a>
            <a href="<?php echo e(route('balitas.status')); ?>" class="menu-item">
                <div class="menu-icon">
...
</html><?php /**PATH C:\xampp\htdocs\balita-app\resources\views/welcome.blade.php ENDPATH**/ ?>