...
<body class="flex items-center justify-center p-8">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg w-full">
        <div class="flex items-center mb-6">
            <a href="<?php echo e(route('balitas.status')); ?>" class="text-gray-500 hover:text-gray-700 mr-4 transition-transform transform hover:scale-110">
                <i class="fas fa-arrow-left text-xl"></i>
            </a>
            <h1 class="text-3xl font-bold text-gray-800"><?php echo e($title); ?></h1>
        </div>
        
        <div class="space-y-4">
            <?php if(count($filteredBalitas) > 0): ?>
                <?php $__currentLoopData = $filteredBalitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white p-6 rounded-lg shadow-md card 
                    <?php if(str_contains($title, 'Aman')): ?>
                        aman-border
                    <?php elseif(str_contains($title, 'Hampir Batas')): ?>
                        mendekati-border
                    <?php elseif(str_contains($title, 'Lewat Batas')): ?>
                        lewat-border
                    <?php endif; ?>
                    " data-tgl-lahir="<?php echo e($balita->tgl_lahir); ?>">
                    <div class="flex items-center justify-between mb-2">
                        <h2 class="text-xl font-semibold text-gray-800"><?php echo e($balita->nama_balita); ?></h2>
                        <span class="text-gray-500 text-sm">
                            <i class="fas fa-id-card"></i> <?php echo e($balita->nik_balita); ?>
                    ...
                    <p class="text-gray-600 mb-1">
                        <i class="fas fa-calendar-alt"></i> <strong>Tanggal Lahir:</strong> <?php echo e($balita->tgl_lahir); ?>

                    </p>
                    <p class="text-gray-600 mb-1">
                        <i class="fas fa-user-friends"></i> <strong>Nama Ortu:</strong> <?php echo e($balita->nama_ortu); ?>

                    </p>
                    <p class="text-gray-600">
                        <i class="fas fa-phone-alt"></i> <strong>No. HP Ortu:</strong> <?php echo e($balita->hp_ortu); ?>

                    </p>
                    <?php if(str_contains($title, 'Lewat Batas')): ?>
                        <div class="mt-4 flex justify-end">
                            <button type="button" class="bg-red-500 text-white px-4 py-2 rounded-lg font-semibold hover:bg-red-600 transition duration-200 delete-btn" data-nik="<?php echo e($balita->nik_balita); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\balita-app\resources\views/balitas/status_list.blade.php ENDPATH**/ ?>