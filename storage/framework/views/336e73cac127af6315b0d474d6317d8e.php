...
<body class="p-8 flex items-center justify-center min-h-screen">
        ...
        <div id="successModal" class="modal">
            <div class="modal-content">
                ...
                <div class="p-4 text-center">
                    ...
                    <p class="text-gray-500"><?php echo e(session('success')); ?></p>
                </div>
            </div>
        </div>
    <?php endif; ?>
        ...
        <div id="errorModal" class="modal">
            <div class="modal-content">
                ...
                <div class="p-4 text-center">
                    ...
                    <p class="text-gray-500"><?php echo e(session('error') ?? 'Data tidak valid. Periksa kembali isian Anda.'); ?></p>
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(request()->query('from') == 'search' ? route('balitas.search', ['nik_balita' => $balita->nik_balita]) : route('balitas.index', ['page' => request()->query('page')])); ?>" class="text-gray-500 hover:text-gray-700">
                <i class="fas fa-arrow-left text-2xl"></i>
            </a>
        </div>
    
        <form id="edit-form" action="<?php echo e(route('balitas.update', $balita->nik_balita)); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                <div>
                    ...
                    <input type="text" id="nik_balita" name="nik_balita" value="<?php echo e(old('nik_balita', $balita->nik_balita)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" inputmode="numeric" pattern="[0-9]*">
                </div>
        
                <div>
                    <label for="nama_balita" class="block text-sm font-medium text-gray-700">Nama Balita</label>
                    <input type="text" id="nama_balita" name="nama_balita" value="<?php echo e(old('nama_balita', $balita->nama_balita)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                </div>
        
                <div>
                    <label for="nama_ortu" class="block text-sm font-medium text-gray-700">Nama Ortu</label>
                    <input type="text" id="nama_ortu" name="nama_ortu" value="<?php echo e(old('nama_ortu', $balita->nama_ortu)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                </div>
        
                <div>
                    <label for="tgl_lahir" class="block text-sm font-medium text-gray-700">Tanggal Lahir</label>
                    <input type="date" id="tgl_lahir" name="tgl_lahir" value="<?php echo e(old('tgl_lahir', $balita->tgl_lahir)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="nomor_kk" name="nomor_kk" value="<?php echo e(old('nomor_kk', $balita->nomor_kk)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" inputmode="numeric" pattern="[0-9]*">
                </div>
        
                <div>
                    <label for="nik_ortu" class="block text-sm font-medium text-gray-700">NIK Ortu</label>
                    <input type="text" id="nik_ortu" name="nik_ortu" value="<?php echo e(old('nik_ortu', $balita->nik_ortu)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" inputmode="numeric" pattern="[0-9]*">
                </div>
        
                <div>
                    <label for="hp_ortu" class="block text-sm font-medium text-gray-700">No. HP Ortu</label>
                    <input type="text" id="hp_ortu" name="hp_ortu" value="<?php echo e(old('hp_ortu', $balita->hp_ortu)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" inputmode="numeric" pattern="[0-9]*">
                </div>
        
                <div>
                    <label for="rt" class="block text-sm font-medium text-gray-700">RT</label>
                    <input type="text" id="rt" name="rt" value="<?php echo e(old('rt', $balita->rt)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" inputmode="numeric" pattern="[0-9]*">
                </div>
        
                <div>
                    <label for="rw" class="block text-sm font-medium text-gray-700">RW</label>
                    <input type="text" id="rw" name="rw" value="<?php echo e(old('rw', $balita->rw)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" inputmode="numeric" pattern="[0-9]*">
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Inisialisasi dropdown dengan nilai dari data balita yang sedang diedit
            (function initializeDropdownsWithBalitaData() {
                const balitaData = {
                    kec: "<?php echo e($balita->kec); ?>",
                    puskesmas: "<?php echo e($balita->puskesmas); ?>",
                    desa_kel: "<?php echo e($balita->desa_kel); ?>",
                    posyandu: "<?php echo e($balita->posyandu); ?>"
                };
            
                // Set nilai awal untuk Kecamatan
                if (balitaData.kec) {
                    setSelectedValue(kecSelect, balitaData.kec.toUpperCase());
                }

                // Perbarui dan set nilai Puskesmas
                ...
                // Perbarui dan set nilai Desa/Kelurahan
                ...
                // Perbarui dan set nilai Posyandu
            ...
            // =========================================================
            // Bagian 3: Validasi Input Sederhana
            // =========================================================
...
</html><?php /**PATH C:\xampp\htdocs\balita-app\resources\views/balitas/edit.blade.php ENDPATH**/ ?>