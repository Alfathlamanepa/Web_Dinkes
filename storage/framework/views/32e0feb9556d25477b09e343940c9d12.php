...
<body class="p-8 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-3xl shadow-2xl max-w-4xl w-full">
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="<?php echo e(request()->query('from') == 'search' ? route('balitas.search', ['nik_balita' => $balita->nik_balita]) : route('balitas.index', ['page' => request()->query('page')])); ?>" id="back-button" class="text-gray-500 hover:text-gray-700 transition-colors duration-200">
        ...
        <?php if($balita): ?>
            <div class="space-y-4">
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <p class="font-semibold text-gray-700">NIK Balita: <span class="font-normal text-gray-900"><?php echo e($balita->nik_balita); ?></span></p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <p class="font-semibold text-gray-700">Nama Balita: <span class="font-normal text-gray-900"><?php echo e($balita->nama_balita); ?></span></p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <p class="font-semibold text-gray-700">Nama Ortu: <span class="font-normal text-gray-900"><?php echo e($balita->nama_ortu); ?></span></p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <p class="font-semibold text-gray-700">NIK Ortu: <span class="font-normal text-gray-900"><?php echo e($balita->nik_ortu); ?></span></p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <p class="font-semibold text-gray-700">HP Ortu: <span class="font-normal text-gray-900"><?php echo e($balita->hp_ortu); ?></span></p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <p class="font-semibold text-gray-700">Tanggal Lahir: <span id="tgl_lahir_display" class="font-normal text-gray-900"><?php echo e($balita->tgl_lahir); ?></span></p>
                </div>
                
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm text-center">
                    <p class="font-semibold text-gray-700">Terakhir Diedit: <span class="font-normal text-gray-900"><?php echo e(\Carbon\Carbon::parse($balita->updated_at)->format('d-m-Y H:i:s')); ?></span></p>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
                    ...
                    <div class="bg-lime-50 p-4 rounded-lg">
                        <p class="font-semibold text-gray-700">RT/RW: <span class="font-normal text-gray-900"><?php echo e($balita->rt); ?>/<?php echo e($balita->rw); ?></span></p>
                        <p class="font-semibold text-gray-700">Desa/Kel: <span class="font-normal text-gray-900"><?php echo e($balita->desa_kel); ?></span></p>
                        <p class="font-semibold text-gray-700">Kecamatan: <span class="font-normal text-gray-900"><?php echo e($balita->kec); ?></span></p>
                        <p class="font-semibold text-gray-700">Puskesmas: <span class="font-normal text-gray-900"><?php echo e($balita->puskesmas); ?></span></p>
                        <p class="font-semibold text-gray-700">Posyandu: <span class="font-normal text-gray-900"><?php echo e($balita->posyandu); ?></span></p>
                        <p class="font-semibold text-gray-700">Kabupaten/Kota: <span class="font-normal text-gray-900"><?php echo e($balita->kab_kota); ?></span></p>
                        <p class="font-semibold text-gray-700">Provinsi: <span class="font-normal text-gray-900"><?php echo e($balita->provinsi); ?></span></p>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\balita-app\resources\views/balitas/show.blade.php ENDPATH**/ ?>